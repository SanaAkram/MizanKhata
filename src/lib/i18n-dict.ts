...
const DICT: Record<string, Entry> = {
  ...
  "c.cancel": { en: "Cancel", ur: "منسوخ", roman: "Cancel karein" },
  ...
  "nav.routine": { en: "Routine", ur: "روٹین", roman: "Mamool" },
  "nav.ledger": { en: "Ledger", ur: "کھاتہ", roman: "Khata" },
  "nav.orders": { en: "Orders", ur: "آرڈر", roman: "Order" },
  ...
  "range.entries": { en: "entries", ur: "اندراجات", roman: "andraaj" },
  "range.entry": { en: "entry", ur: "اندراج", roman: "andraj" },
  "range.netForPeriod": {
    en: "Net for period",
    ur: "اِس مدت کا خالص",
  ...
  "party.entry": { en: "Entry", ur: "اندراج", roman: "Andraj" },
  "party.entries": { en: "Entries", ur: "اندراجات", roman: "Andraaj" },
  "party.view": { en: "View", ur: "دکھاؤ", roman: "Andaz" },
  "party.viewCols": {
    en: "Two columns",
    ur: "دو خانے",
    roman: "Do khane",
  },
  "party.viewList": { en: "List", ur: "فہرست", roman: "Fehrist" },
  "layout.view": { en: "View", ur: "دکھاؤ", roman: "Andaz" },
  "layout.columns": {
    en: "Two columns",
    ur: "دو خانے",
    roman: "Do khane",
  },
  "layout.list": { en: "List", ur: "فہرست", roman: "Fehrist" },
  "layout.default": {
  ...
  "cash.bankBal": { en: "Bank balance", ur: "بینک بیلنس", roman: "Bank baqaya" },
  "cash.entries": { en: "Entries", ur: "اندراجات", roman: "Andraaj" },
  ...
  "cash.category": { en: "category…", ur: "قسم…", roman: "qisam…" },
  ...
  "pos.subTotal": { en: "Sub total", ur: "ذیلی میزان", roman: "Zaili kul" },
  "pos.discount": { en: "Discount", ur: "رعایت", roman: "Riayat" },
  ...
  "pos.mode.cash": { en: "Cash", ur: "نقد", roman: "Naqad" },
  ...
  "bills.badge.cash": { en: "Cash", ur: "نقد", roman: "Naqad" },
  ...
  "bills.qty": { en: "Qty", ur: "تعداد", roman: "Tadaad" },
  "bills.rate": { en: "Rate", ur: "ریٹ", roman: "Rate" },
  "bills.discount": { en: "Discount", ur: "رعایت", roman: "Riayat" },
  ...
  "dash.reports": { en: "Reports", ur: "رپورٹس", roman: "Reportein" },
  ...
  "exp.category": { en: "Category", ur: "قسم", roman: "Qisam" },
  ...
  "exp.entry": { en: "entry", ur: "اندراج", roman: "andraj" },
  "exp.entries": { en: "Entries", ur: "اندراجات", roman: "Andraaj" },
  ...
  "rep.blocks": { en: "Blocks", ur: "خانے", roman: "Khane" },
  ...
  "rep.cashFlow": { en: "Cash flow", ur: "نقد کی آمد و رفت", roman: "Naqdi bahaav" },
  ...
  "ord.noneOpen": {
    ...
    ur: "کوئی کھلا آرڈر نہیں — + دبائیں۔",
    roman: "Koi khula order nahi — + dabayein.",
  },
  "ord.noneDone": {
  ...
  "ord.dirOut": {
    ...
    roman: "Main ne order kiya (supplier)",
  },
  "ord.dirIn": {
    en: "Customer ordered",
    ur: "گاہک نے آرڈر کیا",
    roman: "Customer ne order kiya",
  },
  "ord.pickCustomer": {
    en: "Which customer? (optional)",
    ur: "کون سا گاہک؟ (اختیاری)",
    roman: "Kaunsa customer? (optional)",
  },
  "ord.pickSupplier": {
    en: "Which supplier? (optional)",
    ur: "کون سا سپلائر؟ (اختیاری)",
    roman: "Kaunsa supplier? (optional)",
  },
  "ord.titlePh": {
    en: "What is the order?",
    ur: "آرڈر کیا ہے؟",
    roman: "Order kya hai?",
  },
  "ord.detailsPh": {
  ...
  "stock.outReport": { en: "OUT report", ur: "اخراج رپورٹ", roman: "Bahar report" },
  "stock.addProduct": {
    en: "Add product",
  ...
  "stock.sale": { en: "Sale", ur: "فروخت", roman: "Bikri" },
  ...
  "stock.adjustment": { en: "Adjustment", ur: "درستگی", roman: "Tabdeeli" },
  "stock.stockIn": { en: "Stock IN", ur: "اسٹاک آمد", roman: "Stock andar" },
  "stock.stockOut": { en: "Stock OUT", ur: "اسٹاک اخراج", roman: "Stock bahar" },
  ...
  "stock.date": { en: "Date", ur: "تاریخ", roman: "Tareekh" },
  "stock.ledgerLink": {
    en: "{name} — ledger ›",
    ur: "{name} — کھاتہ ›",
    roman: "{name} — khata ›",
  ...
  "stock.saleRate": { en: "Sale rate", ur: "فروخت ریٹ", roman: "Bikri rate" },
  "stock.addItems": {
  ...
  "routine.checkIn": { en: "Check in", ur: "پوچھ گچھ", roman: "Haazri lagayein" },
  ...
  // ---- shop settings ----------------------------------------------------
  "shopset.business": { en: "Business", ur: "کاروبار", roman: "Karobar" },
  "shopset.active": { en: "active", ur: "فعال", roman: "chaalu" },
  "shopset.newBusiness": {
    en: "+ New business",
    ur: "+ نیا کاروبار",
    roman: "+ Naya business",
